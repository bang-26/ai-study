...
class MySQLClientManager:
    ...
    def _get_url(self):
        return f"mysql+asyncmy://{self.db_config.user}:{self.db_config.api_key}@{self.db_config.host}:{self.db_config.port}/{self.db_config.collection_name}?charset=utf8mb4"

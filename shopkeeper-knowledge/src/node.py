...
from config import PathConfig, app_config
from process import ImageProcess, MineruProcess, DocumentProcess, RecognitionProcess
...
def node_pdf_to_md(state: ImportGraphState) -> ImportGraphState:
    ...
    try:
        ...
        task_util.add_done_task(task_id, function_name)              # 记录任务状态（给前端推送信息）
...
def node_item_name_recognition(state: ImportGraphState) -> ImportGraphState:
    ...
    RecognitionProcess.save_vector(file_title=file_title, item_name=item_name,

        ...
        <el-card class="delivery-section" shadow="hover" style="overflow:auto">
          ...
          <div v-if="deliveryResponse" class="delivery-response">
            ...
            <div v-if="deliveryResponse.distance" class="delivery-details">
              ...
              <p>时间: <span style="color:red">{{ Math.floor(deliveryResponse.duration / 60) }}</span> 分钟
                <span style="color:red"> {{ deliveryResponse.duration % 60 }}</span> 秒</p>
...
.delivery-input .el-input__wrapper
{
  height: 72px;
}
...
.delivery-section .el-card__body
{
  display: flex;
  flex-direction: column;
}
...
.chat-response .formatted-container
{
  flex: 1;
}
</style>
